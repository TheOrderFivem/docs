...
Returns the input resource name.

```lua
local name = Bridge.Input.GetResourceName()
-- Returns: string (always "default")
```

**Description:**
Returns the name of the Input module resource. Used for internal identification. Always returns `"default"` for the built-in Input module.
